...
VARIABLES_LOCALES : VARIABLE_LOCAL COMA VARIABLES_LOCALES
  | VARIABLE_LOCAL
  ;
VARIABLE_LOCAL : TIPO LISTA_IDENTIFICADOR
  ;
LISTA_IDENTIFICADOR : IDENTIFICADOR COMA LISTA_IDENTIFICADOR
  | IDENTIFICADOR
  ;
...
LISTA_VECTORES : VECTOR COMA
    | VECTOR COMA LISTA_VECTORES
